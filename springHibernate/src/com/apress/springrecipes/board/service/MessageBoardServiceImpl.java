...
import com.apress.springrecipes.board.dao.MessageBoardDao;
...
public class MessageBoardServiceImpl implements MessageBoardService {
   ...
   // @Transactional
    public List<Message> listMessages() {
    	List<Message> messageList=messageBoardDao.listMessages();
        return messageList;
    }
    ...
    public synchronized void postMessage(Message message) {
        message.setId(id++);
        messageBoardDao.postMessage(message);
   ...
   // @Secured("ACL_MESSAGE_DELETE")
    public synchronized void deleteMessage(int messageId) {
    	...
    	messageBoardDao.deleteMessage(messageId);
	/*ObjectIdentity oid =
